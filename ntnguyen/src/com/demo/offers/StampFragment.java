...
//		mFrameLayout = (FrameLayout) view.findViewById(R.id.details_stamp_frame);
		...
		mStampView.setOffersStampCardViewListener(
				new OffersStampCardView.OffersStampCardViewListener(){
			@Override
		...
		OffersKit.getInstance().stampCardPresents(mStamp_card_id, new OffersListener(){
			...
			public void onDone(Map<String, Object> result) {
				...
				if(status.getCode() == 0){
					...
					fragment.stampCallback = true;
					fragment.mListCouponStamp = (ArrayList<OffersCoupon>) coupons;
