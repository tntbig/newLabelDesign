...
public class CustomDrawerAdapter extends ArrayAdapter<DrawerItem> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			drawerHolder.title = (TextView) view.findViewById(R.id.tv_title_parent);
			drawerHolder.group = (TextView) view.findViewById(R.id.tv_career);
		...
		if (!"".equals(dItem.getUser())) {
			...
			drawerHolder.group.setText(MainActivity.staticGroupName.replace(" ", ""));
	...
	private static class DrawerItemHolder {
		TextView ItemName, title, user, group, reset;
